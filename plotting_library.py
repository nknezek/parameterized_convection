...
def plot_thermal_history2(times, T_cmb, T_upper_mantle, times_calculated=None, T_upper_magma_ocean=None, D_magma_ocean=None, r_i=None):
    fig = plt.figure(figsize=(8,6))
    plt.plot( times, T_cmb)
    # plt.plot( times_calculated, T_upper_magma_ocean)
    plt.plot( times, T_upper_mantle)
    ...
    plt.xlabel(r"Time (Myr)")
    plt.legend(["T - core mantle boundary", "T - upper mantle", "Inner-core radius" ], loc=0)
    # plt.grid()
